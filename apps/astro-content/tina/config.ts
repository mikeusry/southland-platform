...
export default defineConfig({
  ...
  schema: {
    collections: [
      ...
      // NOTE: Products collection removed from TinaCMS — it was overwriting
      // enriched MDX frontmatter on dev server sync. Products are managed
      // directly in git at src/content/products/. Re-add when editorial
      // workflow is ready with field preservation guarantees.
      {
