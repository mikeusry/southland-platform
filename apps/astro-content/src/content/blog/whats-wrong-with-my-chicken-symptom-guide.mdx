...
3. **If parasites:** treat the coop with [Desecticide](/products/desecticide/) — a surfactant-based spray for roosts, nesting boxes, and wall joints where mites hide during the day. It's labeled for surfaces, not for application to birds; for mites already on the flock, ask a vet about a bird-safe treatment
