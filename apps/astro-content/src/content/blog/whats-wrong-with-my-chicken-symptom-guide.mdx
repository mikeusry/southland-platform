...
3. **If parasites:** treat the coop with [Desecticide](/products/natural-mite-control-livestock-poultry/) — a surfactant-based spray for roosts, nesting boxes, and wall joints where mites hide during the day. It's labeled for surfaces, not for application to birds; for mites already on the flock, ask a vet about a bird-safe treatment
4. **If molting:** this is normal. Support with extra protein (16-20% feed) and daily [Hen Helper](/products/hen-helper/) at 1 tablespoon per gallon — double it through the heaviest weeks of regrowth
...
| **Nutrient deficiency**     | Thin shells, soft shells, or no shells                    | Check the calcium source first — oyster shell free-choice. [Hen Helper](/products/hen-helper/) supports the gut health behind nutrient absorption |
...
### Is sneezing in chickens always serious?

Not always. A single sneeze after dust exposure or a feed change is normal. Concern starts when sneezing comes with discharge from the eyes or nose, swollen sinuses, gurgling breathing, or when more than one bird is affected. Two or more birds with respiratory symptoms is the threshold to act — isolate, clean the coop, and call a vet if symptoms don't resolve in 48 hours.

### When should I cull a sick chicken instead of treating?

Cull when the bird can't stand, won't eat or drink for 24+ hours, has visible tumors or massive swelling, or is being attacked by the flock. Treat when the bird is alert, eating, and the symptom is something you can identify and address (mites, mild respiratory, minor wound). When in doubt, separate the bird and watch for 24 hours before deciding.

### Can backyard chickens make humans sick?

Yes — Salmonella is the main risk, especially for kids under 5 and immunocompromised adults. Wash hands after handling birds or eggs, don't kiss your chickens, keep coop shoes outside, and never bring chickens into the house. Healthy-looking birds can still carry Salmonella.

### How fast can a respiratory disease wipe out a flock?

Highly pathogenic avian influenza can kill an entire flock in 48 hours. Mycoplasma and infectious bronchitis are slower (days to weeks) but spread to every bird. This is why two or more birds with respiratory symptoms is a hard line — the cost of waiting is much higher than the cost of acting.

### Do probiotics actually prevent disease in chickens?

Probiotics don't cure or prevent specific diseases, but a competitive gut microbiome makes it harder for pathogens like Salmonella, E. coli, and Clostridium to colonize. In UGA field trials on our own commercial product, houses on a daily probiotic saw a 6.2% mortality reduction versus untreated controls. For backyard flocks the effect is harder to measure but the cost is low and the downside is zero.

### What's the most useful thing I can do when a chicken dies?

Send the body to your state poultry diagnostic lab for a necropsy ($20-50 at most land-grant universities). One properly examined dead bird tells you more about what's happening in your flock than months of internet searches. Keep the body cool (not frozen) and ship within 24 hours.
