...
Some kinds of chicken poo can give you early indications of specific infections. Take bloody diarrhea for instance. This can be caused by anything that damages the inside of the intestines like bacterial infections or worms, but the most common cause is [coccidiosis](/blog/coccidiosis-in-chickens-causes-and-prevention/ 'Coccidiosis').
...
If droppings are pasting up and sticking around the vent itself—rather than showing up as a change in the stool—that's a different problem. In chicks it's [pasty butt, and in adult hens it's vent gleet](/blog/treating-vent-gleet-and-pasty-butt-in-chickens/ 'Pasty Butt & Vent Gleet in Chickens'), both of which trace back to gut imbalance and need a targeted gut-health fix.
...
In cases of mild digestive upset and even some bacterial presence, probiotics like [Hen Helper](/products/hen-helper/ 'Hen Helper') and [Big Ole Bird](/products/poultry-probiotic/ 'Big Ole Bird') can be incredibly helpful in correcting chicken digestion. For clearing mucus accumulation, probiotics can be helpful as well as apple cider vinegar supplements like [Mother Load](/products/apple-cider-vinegar-for-chickens/ 'Mother Load').
