...
At Southland Organics, it all starts with organic matter. What do we mean by this? Well, most of our products are based on organic matter — living microbial systems that bring life to lawns, gardens, and poultry environments.

Some of our products are registered with WSDA as approved for use in organic agriculture. That registration means a certifier can allow the product on an organic farm; it does **not** mean the product itself is a USDA Certified Organic agricultural product. We are a small business, and we put our energy into formulation and results rather than chasing a USDA seal on inputs that the NOP does not certify that way. You can look at the ingredients and see what is in them, and we are happy to answer questions about our products if you ever have them.
