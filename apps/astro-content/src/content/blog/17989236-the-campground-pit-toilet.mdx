...
Decomposition may be accelerated by stirring or turning the pile, which breaks up the pile and introduces both air pockets and air channels into the pile to allow faster organism growth within the bed of solids. There are also commercial products, such as [PORT](/products/holding-tank-treatment/), that add a mixture of bacteria, fungus and nitrogen to give a spurt of activity and accelerate the composting process within the pit.
...
[PORT](/products/holding-tank-treatment/), which stands for Portable Outdoor Restroom Treatment, is a powerful solution that provides rapid waste degradation and odor control. PORT is great for a portable toilet or an outdoor toilet!
