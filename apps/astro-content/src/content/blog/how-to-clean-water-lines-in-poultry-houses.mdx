...
muxPlaybackIds: ['fFeeov01NC7K01gToV2enVKtVnAEbK3RBNOl5z1db017uY']
...
Many growers use one of two common cleaning products to clean their water lines: chlorine or peroxide. A newer option — hypochlorous acid (HOCl) — is also worth understanding. We cover that approach in detail in [Choosing the Right Line Cleaner](/blog/choosing-the-right-line-cleaner/), and it's the chemistry behind our [ZeroPoint](/products/zeropoint-industrial/) program.
