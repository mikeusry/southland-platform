...
The first step in this is achieving the right carbon to nitrogen ratio. Poultry farmer, Jason Jackson, explains that this can be especially challenging because of the constant addition of nitrogen through the birds' droppings. You need the right solution of active carbon to challenge the continual nitrogen flow. [Southland Organics’ Litter Life](/products/poultry-litter-amendment/ 'Litter Life — Poultry Litter Amendment') uses a biologically active carbon that accelerates decomposition of the litter and helps your house achieve the right balance.
