...
humus) gets burned up in the assimilation process of nitrogen. Synthetics can change the pH and tie up beneficial elements ([see the effect of soil pH on plants](/blog/the-effect-of-soil-ph-on-plants/ 'The Effect of Soil pH on Plants') for how that plays out), but also can start to cause toxicity levels of other elements. Artificial inducement of one element can cause all kinds of weird bonding to occur with other elements. This all translates to the foods which we eat. With naturally grown foods, you do not have to worry about pesticides or herbicides, but probably the best benefit of organic foods is their nutritional content. The difference can be dramatic. This includes livestock and poultry which are fed naturally grown grasses and food. As a culture, we are becoming more and more nutritionally deficient and filled with toxic residues as an indirect result of synthetic fertilizers. This stresses the body, making it more prone to health problems.
...
Citation: [https://www.researchgate.net/post/How_is_plant_nutrition_being_affected_since_the_widespread_use_of_synthetic_fertilizers](https://www.researchgate.net/post/How_is_plant_nutrition_being_affected_since_the_widespread_use_of_synthetic_fertilizers)
