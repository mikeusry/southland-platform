...
export default function SavingsDisplay({ subtotal, discountPercent, filled, total = 4 }: Props) {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
      <div className="flex items-center justify-between text-sm">
        ...
        <span className="font-medium text-shopify-text">{formatMoney(subtotal)}</span>
      </div>
