...
export const PAGE_GROUPS: PageGroup[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    pages: [
      ...
      {
        route: '/poultry/commercial/',
        name: 'Broiler Bill Landing',
        pageType: 'lander',
        persona: 'bill',
        funnelStage: 'consideration',
        searchIntent: 'commercial',
        primaryGoal: 'Call sales',
        priority: 'high',
        contentType: 'non-content',
        pipeline: 'shipped',
      },
      {
        route: '/poultry/backyard/',
        name: 'Backyard Betty Landing',
        pageType: 'lander',
        persona: 'betty',
        funnelStage: 'consideration',
        searchIntent: 'commercial',
        primaryGoal: 'Add to cart',
        priority: 'high',
        contentType: 'non-content',
        pipeline: 'shipped',
      },
      {
        route: '/poultry/breeders/',
        name: 'Breeder Bob Landing',
        pageType: 'lander',
        persona: 'bob',
        funnelStage: 'consideration',
        searchIntent: 'commercial',
      ...
      {
        route: '/poultry/turkey/',
        name: 'Turkey Tom Landing',
        pageType: 'lander',
        persona: 'tom',
        funnelStage: 'consideration',
        searchIntent: 'commercial',
      ...
      {
        route: '/poultry/game-birds/',
        name: 'Game Bird Greg Landing',
        pageType: 'lander',
        persona: 'greg',
        funnelStage: 'consideration',
        searchIntent: 'commercial',
      ...
      {
        route: '/lawn/',
        name: 'Turf Pro Taylor Landing',
        pageType: 'lander',
        persona: 'taylor',
        funnelStage: 'consideration',
        searchIntent: 'commercial',
        primaryGoal: 'Build program',
        priority: 'high',
        contentType: 'non-content',
        blocker: 'copy',
      },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    pages: [
      {
        route: '/livestock/swine/',
        name: 'Pig & Swine Supplements',
        pageType: 'collection',
        persona: 'general',
        funnelStage: 'consideration',
        searchIntent: 'commercial',
  ...
  // -------------------------------------------------------------------------
  {
    ...
    pages: [
      ...
      },
      {
        ...
        priority: 'high',
        contentType: 'dynamic',
        auditLink: '/admin/site-audit/products',
      },
      {
        route: '/build-a-case/',
        name: 'Mix & Match Case Builder',
        pageType: 'utility',
        persona: 'general',
        funnelStage: 'purchase',
        searchIntent: 'transactional',
        primaryGoal: 'Build bundle',
        priority: 'high',
        contentType: 'non-content',
      },
      {
        route: '/products/sanitizers/',
        name: 'Sanitizers',
        pageType: 'collection',
        persona: 'general',
        funnelStage: 'consideration',
      ...
      {
        route: '/products/waste-treatment/',
  ...
  // -------------------------------------------------------------------------
  {
    ...
    pages: [
      ...
      {
        route: '/podcast/topics/',
        name: 'Topics Index',
        pageType: 'hub',
        persona: 'general',
        funnelStage: 'awareness',
        searchIntent: 'informational',
        primaryGoal: 'Browse topics',
        priority: 'medium',
        contentType: 'index',
        pipeline: 'shipped',
      },
      ...
      {
        route: '/podcast/guests/',
        name: 'Guests Index',
        pageType: 'hub',
        persona: 'general',
        funnelStage: 'awareness',
        searchIntent: 'informational',
        primaryGoal: 'Browse guests',
        priority: 'low',
        contentType: 'index',
        pipeline: 'shipped',
      },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    pages: [
      ...
      },
      {
        ...
        scanCollection: 'blog',
        pipeline: 'shipped',
        auditLink: '/admin/site-audit/blog',
      },
      {
        route: '/blog/category/[segment]',
        name: 'Category Archives',
        pageType: 'hub',
        persona: 'general',
        funnelStage: 'awareness',
        searchIntent: 'informational',
        primaryGoal: 'Browse category',
        priority: 'medium',
        contentType: 'non-content',
        pipeline: 'shipped',
      },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    pages: [
      {
        route: '/blog/whats-wrong-with-my-chicken-symptom-guide/',
        name: "What's Wrong With My Chicken?",
        pageType: 'content',
        persona: 'betty',
        funnelStage: 'consideration',
        searchIntent: 'informational',
        primaryGoal: 'Diagnose + recommend product',
        priority: 'high',
        contentType: 'dynamic',
        pipeline: 'built',
        owner: 'mike-usry',
      ...
      {
        route: '/blog/backyard-chicken-dosing-guide/',
        name: 'Dosing Guide for Small Flocks',
        pageType: 'content',
        persona: 'betty',
        funnelStage: 'consideration',
        searchIntent: 'commercial',
        primaryGoal: 'Remove purchase barrier',
        priority: 'high',
        contentType: 'dynamic',
        pipeline: 'built',
        owner: 'mike-usry',
      ...
      {
        route: '/blog/new-chicken-owner-first-30-days/',
        name: 'First 30 Days With Chickens',
        pageType: 'content',
        persona: 'betty',
        funnelStage: 'awareness',
        searchIntent: 'informational',
        primaryGoal: 'Onboard new owners',
        priority: 'high',
        contentType: 'dynamic',
        pipeline: 'built',
        owner: 'mike-usry',
  ...
  // -------------------------------------------------------------------------
  {
    ...
    pages: [
      {
        route: '/survey/backyard',
        name: 'Betty Outcome Survey',
        pageType: 'utility',
        persona: 'betty',
        funnelStage: 'post-purchase',
        searchIntent: 'navigational',
        primaryGoal: 'Collect outcomes',
        priority: 'medium',
        contentType: 'non-content',
        blocker: 'data',
      },
      {
        route: '/survey/commercial',
        name: 'Bill Outcome Survey',
        pageType: 'utility',
        persona: 'bill',
        funnelStage: 'post-purchase',
        searchIntent: 'navigational',
