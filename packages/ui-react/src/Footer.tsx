...
const DEFAULT_MOLECULES_URL =
  'https://res.cloudinary.com/southland-organics/image/upload/f_auto,q_auto/Southland%20Website/Footer_bg_qtqx95'

// Default white logo from Cloudinary (square white version)
const DEFAULT_WHITE_LOGO_URL =
  'https://res.cloudinary.com/southland-organics/image/upload/f_auto,q_auto,w_400/Southland%20Website/Southland%20Branding/logos/Southland_Organics_Square_White_tuwhqk'
    ...
    <footer>
      ...
      >
        <div className="mx-auto max-w-[1400px] px-4 py-12 sm:px-6 md:py-16 lg:px-8">
          ...
          {/* Four column layout */}
          <div className="grid grid-cols-1 gap-8 text-white sm:grid-cols-2 lg:grid-cols-4 lg:gap-12">
            {/* Column 1 - Company info + Social */}
            <div className="text-center sm:text-left">
              <h3 className="mb-4 text-lg font-semibold">Southland Organics</h3>
              <p className="mb-4 whitespace-pre-line text-sm text-white/90">{address}</p>
              <a
              ...
              {/* Social links */}
              <div className="mt-6">
                <h4 className="mb-3 text-sm font-semibold">Let's Be Social</h4>
            ...
            <div className="text-center sm:text-left">
              <h3 className="mb-4 text-lg font-semibold">Ag & Culture Podcast</h3>
              <ul className="space-y-2">
                {visibleColumns
                  .find((c) => c.title.includes('Podcast'))
                  ?.links.map((link) => (
                    <li key={link.label}>
                      <a
                        href={link.href}
              ...
              {/* Sam.Gov section */}
              <div className="mt-6">
                <h4 className="mb-2 text-sm font-semibold">Sam.Gov</h4>
                <p className="text-xs text-white/80">
                  Southland Organics is fully registered with Sam.gov!
                  <br />
        ...
        <div className="mx-auto max-w-[1400px] px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 text-sm text-white/90 sm:justify-end">
              ...
              <a
                href="https://www.southlandorganics.com/pages/terms-of-service"
              ...
              <span>|</span>
              <a
                href="https://www.southlandorganics.com/pages/privacy-policy"
                className="transition-colors hover:text-white"
              >
                Privacy Policy
              </a>
              <span>|</span>
              <a
                href="https://www.southlandorganics.com/pages/shipping-policy"
                className="transition-colors hover:text-white"
              >
                Shipping & Returns
              </a>
